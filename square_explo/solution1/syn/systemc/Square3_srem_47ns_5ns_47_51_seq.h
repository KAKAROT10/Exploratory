...
#ifndef __Square3_srem_47ns_5ns_47_51_seq__HH__
#define __Square3_srem_47ns_5ns_47_51_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Square3_srem_47ns_5ns_47_51_seq) {
    ...
    ACMP_srem_seq<ID, 51, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_srem_seq_U;

    SC_CTOR(Square3_srem_47ns_5ns_47_51_seq):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
