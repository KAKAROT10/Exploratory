...
set id 1
set name Square_root_srem_51ns_5ns_5_55_seq
...
set id 2
set name Square_root_mul_54ns_51s_105_5
...
set id 3
set name Square_root_mac_muladd_5s_5s_15s_32_1
...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {5 1 +} i1 {5 1 +} m {10 1 +} i2 {15 1 +} p {32 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 4
set MemName Square_root_dup_arr
