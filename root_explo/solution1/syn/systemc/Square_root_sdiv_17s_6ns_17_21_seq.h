...
#ifndef __Square_root_sdiv_17s_6ns_17_21_seq__HH__
#define __Square_root_sdiv_17s_6ns_17_21_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Square_root_sdiv_17s_6ns_17_21_seq) {
    ...
    ACMP_sdiv_seq<ID, 21, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(Square_root_sdiv_17s_6ns_17_21_seq):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
