...
#ifndef __Square_root_mul_54ns_51s_105_5__HH__
#define __Square_root_mul_54ns_51s_105_5__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Square_root_mul_54ns_51s_105_5) {
    ...
    SC_CTOR(Square_root_mul_54ns_51s_105_5):  ACMP_mul_us_U ("ACMP_mul_us_U") {
