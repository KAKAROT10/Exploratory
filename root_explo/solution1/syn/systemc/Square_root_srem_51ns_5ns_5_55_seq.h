...
#ifndef __Square_root_srem_51ns_5ns_5_55_seq__HH__
#define __Square_root_srem_51ns_5ns_5_55_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Square_root_srem_51ns_5ns_5_55_seq) {
    ...
    ACMP_srem_seq<ID, 55, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_srem_seq_U;

    SC_CTOR(Square_root_srem_51ns_5ns_5_55_seq):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
