...
const sc_lv<32> Square_root_dup::ap_const_lv32_5 = "101";
const sc_lv<32> Square_root_dup::ap_const_lv32_6 = "110";
...
Square_root_dup::Square_root_dup(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    Square_root_mul_54ns_51s_105_5_U2 = new Square_root_mul_54ns_51s_105_5<1,5,54,51,105>("Square_root_mul_54ns_51s_105_5_U2");
    Square_root_mul_54ns_51s_105_5_U2->clk(ap_clk);
    Square_root_mul_54ns_51s_105_5_U2->reset(ap_rst);
    Square_root_mul_54ns_51s_105_5_U2->din0(grp_fu_207_p0);
    Square_root_mul_54ns_51s_105_5_U2->din1(grp_fu_207_p1);
    Square_root_mul_54ns_51s_105_5_U2->ce(ap_var_for_const0);
    Square_root_mul_54ns_51s_105_5_U2->dout(grp_fu_207_p2);
    Square_root_mac_muladd_5s_5s_15s_32_1_U3 = new Square_root_mac_muladd_5s_5s_15s_32_1<1,1,5,5,15,32>("Square_root_mac_muladd_5s_5s_15s_32_1_U3");
    Square_root_mac_muladd_5s_5s_15s_32_1_U3->din0(grp_fu_382_p0);
    Square_root_mac_muladd_5s_5s_15s_32_1_U3->din1(grp_fu_382_p1);
    Square_root_mac_muladd_5s_5s_15s_32_1_U3->din2(grp_fu_382_p2);
    Square_root_mac_muladd_5s_5s_15s_32_1_U3->dout(grp_fu_382_p3);
    ...
    sensitive << ( tmp_3_reg_420 );
    sensitive << ( tmp_1_cast_reg_430 );
    ...
    SC_METHOD(thread_cou1_cast2_fu_225_p1);
    ...
    sensitive << ( p_lshr_f_cast_reg_425 );
    sensitive << ( ap_sig_cseq_ST_st57_fsm_56 );
    sensitive << ( i_reg_124 );
    ...
    sensitive << ( mul_reg_440 );

    SC_METHOD(thread_neg_ti_fu_288_p2);
    sensitive << ( tmp_10_fu_281_p3 );

    SC_METHOD(thread_p_lshr_f_cast_fu_229_p4);
    sensitive << ( indvars_iv_reg_103 );
    ...
    SC_METHOD(thread_tmp_1_cast_fu_239_p1);
    sensitive << ( p_lshr_f_cast_fu_229_p4 );

    SC_METHOD(thread_tmp_1_fu_274_p1);
    sensitive << ( tmp_17_fu_264_p4 );

    SC_METHOD(thread_tmp_3_fu_221_p1);
    sensitive << ( indvars_iv_reg_103 );

    SC_METHOD(thread_tmp_5_fu_278_p1);
    sensitive << ( tmp_18_reg_445 );

    SC_METHOD(thread_tmp_6_fu_243_p2);
    sensitive << ( cou1_cast2_fu_225_p1 );
    ...
    sc_trace(mVcdFile, tmp_3_fu_221_p1, "tmp_3_fu_221_p1");
    sc_trace(mVcdFile, tmp_3_reg_420, "tmp_3_reg_420");
    sc_trace(mVcdFile, p_lshr_f_cast_fu_229_p4, "p_lshr_f_cast_fu_229_p4");
    sc_trace(mVcdFile, p_lshr_f_cast_reg_425, "p_lshr_f_cast_reg_425");
    sc_trace(mVcdFile, tmp_1_cast_fu_239_p1, "tmp_1_cast_fu_239_p1");
    sc_trace(mVcdFile, tmp_1_cast_reg_430, "tmp_1_cast_reg_430");
    ...
    sc_trace(mVcdFile, mul_reg_440, "mul_reg_440");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st6_fsm_5, "ap_sig_cseq_ST_st6_fsm_5");
    sc_trace(mVcdFile, ap_sig_124, "ap_sig_124");
    sc_trace(mVcdFile, tmp_18_reg_445, "tmp_18_reg_445");
    sc_trace(mVcdFile, tmp_14_fu_294_p3, "tmp_14_fu_294_p3");
    sc_trace(mVcdFile, tmp_14_reg_450, "tmp_14_reg_450");
    ...
    sc_trace(mVcdFile, cou1_cast2_fu_225_p1, "cou1_cast2_fu_225_p1");
...
Square_root_dup::~Square_root_dup() {
    ...
    delete Square_root_mul_54ns_51s_105_5_U2;
    delete Square_root_mac_muladd_5s_5s_15s_32_1_U3;
}
...
void Square_root_dup::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
        ...
        y1_reg_114 = tmp_14_reg_450.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && 
         !esl_seteq<1,1,1>(tmp_fu_185_p2.read(), ap_const_lv1_0))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st57_fsm_56.read())) {
        i_1_reg_458 = i_1_fu_320_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st6_fsm_5.read())) {
        mul_reg_440 = grp_fu_207_p2.read();
        tmp_18_reg_445 = grp_fu_207_p2.read().range(104, 56);
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && !esl_seteq<1,1,1>(tmp_fu_185_p2.read(), ap_const_lv1_0))) {
        p_lshr_f_cast_reg_425 = indvars_iv_reg_103.read().range(4, 1);
        tmp_1_cast_reg_430 = tmp_1_cast_fu_239_p1.read();
        tmp_3_reg_420 = tmp_3_fu_221_p1.read();
        tmp_6_reg_435 = tmp_6_fu_243_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        tmp_14_reg_450 = tmp_14_fu_294_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_185_p2.read(), ap_const_lv1_0))) {
...
void Square_root_dup::thread_ap_sig_124() {
...
void Square_root_dup::thread_ap_sig_144() {
    ap_sig_144 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(56, 56));
}

void Square_root_dup::thread_ap_sig_167() {
    ap_sig_167 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(57, 57));
}

void Square_root_dup::thread_ap_sig_189() {
    ap_sig_189 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(55, 55));
}

void Square_root_dup::thread_ap_sig_311() {
    ap_sig_311 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(58, 58));
}
...
void Square_root_dup::thread_ap_sig_cseq_ST_st6_fsm_5() {
    if (ap_sig_124.read()) {
...
void Square_root_dup::thread_ap_sig_cseq_ST_st7_fsm_6() {
    if (ap_sig_135.read()) {
...
void Square_root_dup::thread_arr_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st56_fsm_55.read())) {
        arr_address0 =  (sc_lv<5>) (cou1_cast_reg_396.read());
                ...
                !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_3_reg_420.read()))) {
        arr_address0 =  (sc_lv<5>) (tmp_1_cast_reg_430.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st57_fsm_56.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_315_p2.read()))) {
...
void Square_root_dup::thread_cou1_cast2_fu_225_p1() {
    cou1_cast2_fu_225_p1 = esl_zext<6,5>(indvars_iv_reg_103.read());
}
...
void Square_root_dup::thread_exitcond_fu_315_p2() {
    exitcond_fu_315_p2 = (!i_reg_124.read().is_01() || !p_lshr_f_cast_reg_425.read().is_01())? sc_lv<1>(): sc_lv<1>(i_reg_124.read() == p_lshr_f_cast_reg_425.read());
}
...
void Square_root_dup::thread_grp_fu_207_p0() {
    grp_fu_207_p0 =  (sc_lv<54>) (ap_const_lv105_1999999999999A);
}

void Square_root_dup::thread_grp_fu_207_p1() {
    grp_fu_207_p1 =  (sc_lv<51>) (y1_reg_114.read());
}
...
void Square_root_dup::thread_neg_mul_fu_259_p2() {
    neg_mul_fu_259_p2 = (!ap_const_lv105_0.is_01() || !mul_reg_440.read().is_01())? sc_lv<105>(): (sc_biguint<105>(ap_const_lv105_0) - sc_biguint<105>(mul_reg_440.read()));
}
...
void Square_root_dup::thread_p_lshr_f_cast_fu_229_p4() {
    p_lshr_f_cast_fu_229_p4 = indvars_iv_reg_103.read().range(4, 1);
}
...
void Square_root_dup::thread_tmp_13_fu_376_p3() {
    tmp_13_fu_376_p3 = (!tmp_3_reg_420.read()[0].is_01())? sc_lv<32>(): ((tmp_3_reg_420.read()[0].to_bool())? grp_fu_382_p3.read(): tmp_11_fu_372_p1.read());
}
...
void Square_root_dup::thread_tmp_1_cast_fu_239_p1() {
    tmp_1_cast_fu_239_p1 = esl_zext<64,4>(p_lshr_f_cast_fu_229_p4.read());
}
...
void Square_root_dup::thread_tmp_3_fu_221_p1() {
    tmp_3_fu_221_p1 = indvars_iv_reg_103.read().range(1-1, 0);
}

void Square_root_dup::thread_tmp_5_fu_278_p1() {
    tmp_5_fu_278_p1 = esl_sext<52,49>(tmp_18_reg_445.read());
}

void Square_root_dup::thread_tmp_6_fu_243_p2() {
    tmp_6_fu_243_p2 = (!ap_const_lv6_3F.is_01() || !cou1_cast2_fu_225_p1.read().is_01())? sc_lv<6>(): (sc_bigint<6>(ap_const_lv6_3F) + sc_biguint<6>(cou1_cast2_fu_225_p1.read()));
}
...
void Square_root_dup::thread_tmp_7_fu_326_p2() {
    tmp_7_fu_326_p2 = (!tmp_6_reg_435.read().is_01() || !i_cast1_fu_306_p1.read().is_01())? sc_lv<6>(): (sc_biguint<6>(tmp_6_reg_435.read()) - sc_biguint<6>(i_cast1_fu_306_p1.read()));
}
